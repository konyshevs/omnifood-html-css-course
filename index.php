...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Omnifood is a premium food delivery service"
    />
    ...
    ></script>
    <script defer src="/vendors/js/jquery.waypoints.min.js"></script>
  ...
  <body>
      ...
      <nav>
        <div class="row">
          ...
          <ul class="main-nav js--main-nav">
            <li><a class="main-nav-btn" href="#features">Food delivery</a></li>
            <li><a class="main-nav-btn" href="#steps">How it works</a></li>
            <li><a class="main-nav-btn" href="#cities">Our cities</a></li>
            <li><a class="main-nav-btn" href="#plans">Sign up</a></li>
          </ul>
    ...
    <section class="section-features js--section-features" id="features">
      ...
      <div class="row js--wp-1">
        ...
        <div class="col span-1-of-4 box">
          ...
          <p>
            ou're only twenty minutes away from your delicious and super healthy
    ...
    <section class="section-cities" id="cities">
      ...
      <div class="row js--wp-3">
        <div class="col span-1-of-4 box">
          <img
            src="/resources/img/lisbon-3.jpg"
            alt="Lisbon photo"
            class="city-img"
          />
          <h3 class="city-title">Lisbon</h3>
        ...
        <div class="col span-1-of-4 box">
          <img
            src="/resources/img/san-francisco.jpg"
            alt="San Francisco photo"
            class="city-img"
          />
          <h3 class="city-title">San Francisco</h3>
          <div class="city-feature">
            <ion-icon name="person" class="icon-small"></ion-icon>
            3700+ happy eaters
          </div>
        ...
        <div class="col span-1-of-4 box">
          <img
            src="/resources/img/berlin.jpg"
            alt="Berlin photo"
            class="city-img"
          />
          <h3 class="city-title">Berlin</h3>
          <div class="city-feature">
            <ion-icon name="person" class="icon-small"></ion-icon>
            2300+ happy eaters
          </div>
    ...
    <section class="section-plans js--sections-plans" id="plans">
      <div class="row">
        ...
        <div class="col span-1-of-3">
          <div class="plan-box js--wp-4">
            <div class="">
              ...
              <p class="plan-prise-meal">That’s only 13.30$ per meal</p>
            </div>
            <div class="">
              <ul>
                <li>
        ...
        <div class="col span-1-of-3">
          <div class="plan-box">
            <div class="">
              ...
              <p class="plan-prise-meal">That’s only 14.90$ per meal</p>
            </div>
            <div class="">
              <ul>
                <li>
        ...
        <div class="col span-1-of-3">
          <div class="plan-box">
            <div class="">
              ...
              <p class="plan-prise-meal">&nbsp</p>
            </div>
            <div class="">
              <ul>
                <li>
    ...
    <section class="section-form" id="form">
      ...
      <div class="row">
        <form class="contact-form" action="mailer.php">
          ...
          <div class="row">
            <div class="col span-1-of-3">
              <label for="massege">Drop us a line</label>
            </div>
            <div class="col span-2-of-3">
              <textarea
                name="massege"
    ...
    <footer>
      ...
      <div class="row">
        <p>
          Build with love by Konyshevs in the beautiful city of Tel Aviv,
          Israel, May 2021.
        </p>
      </div>
    </footer>
